...
| Private full SDK (local) | R3D: `~/code/r3d-sdk-private/R3DSDKv9_2_1` — CI feed `derek-rein/r3d-sdk-private` release `sdk-9.2.1`. BRAW: `~/.braw-sdk/` or `~/code/braw-sdk-private/BlackmagicRAWSDK-6.0` — CI feed `derek-rein/braw-sdk-private` release `sdk-6.0`. Both feeds use secret `R3D_SDK_READ_TOKEN` (same PAT). Never commit either SDK. |
...
make braw-sdk-fetch # download private BRAW SDK (needs R3D_SDK_READ_TOKEN / gh)
